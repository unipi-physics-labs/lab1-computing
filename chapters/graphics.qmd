...
ad essere rappresentata in questo modo. Ci torniamo tra un attimo.
...
preciso di illustrare proprio questo.)
...
per ridurre la dimensione. Nonostante questo, *la dimensione di un'immagine raster, sotto
...
Per i formati vettoriali è esattamente l'opposto: le dimensioni del file immagine
